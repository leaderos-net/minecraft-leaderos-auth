...
/**
 * Chat utility class for handling message formatting and sending
 */
public class ChatUtil {
    ...
    public static Component color(String message) {
        ...
        while (hexMatcher.find()) {
            ...
            String replacement = LegacyComponentSerializer.legacyAmpersand()
                    .serialize(Component.text("").color(textColor));
     ...
     * <p>
     * <b>also format chat messages too @see ChatUtil#color(String)</b>
     * </p>
     *
